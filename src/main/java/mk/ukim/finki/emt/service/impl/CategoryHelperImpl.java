...
import mk.ukim.finki.emt.persistence.CategoryPictureRepository;
...
public class CategoryHelperImpl implements CategoryServiceHelper {
  ...
  @Autowired
  public CategoryHelperImpl(CategoryRepository repository, CategoryPictureRepository categoryPictureRepository) {
  ...
  public CategoryPicture addCategoryPicture(Long categoryId, byte[] bytes, String contentType) throws SQLException {
    ...
    categoryPicture.category = repository.findOne(categoryId);
    ...
    picture.fileName = categoryPicture.category.name;
    categoryPicture.picture = picture;
    return categoryPictureRepository.save(categoryPicture);
  }
